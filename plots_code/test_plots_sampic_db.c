void test_plots_sampic_db(){

int multi = 1;
TCanvas *c1 = new TCanvas("c1", "c1", 10,10,900,multi*700);
c1->Divide(2,multi*3);

TFile *file0 = TFile::Open("DQM_V0001_CTPPS_R000366425_sampic.root");
TH2F* hh = nullptr;
...
c1->SaveAs("sampic_45_220_nrhr_db.pdf");
...
c1->SaveAs("sampic_45_220_cylhr_db.pdf");
...
c1->SaveAs("sampic_56_220_nrhr_db.pdf");
...
c1->SaveAs("sampic_56_220_cylhr_db.pdf");
